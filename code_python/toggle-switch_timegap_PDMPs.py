...
def main(timegap,M,n,G, parameters,CI,tms,t1,n_simu,epsilon,div,state):
    ...
    with open(f'../visualisation/Results_files/Entropybytimegap_PDMPs_{state}.csv', 'w', newline='') as f:
        writer = csv.writer(f)
        headers = ["timegap", 
...
M=100
timegap_st = np.arange(t1_st+5,65,5)
timegap_tr = np.arange(t1_tr+20,70,10)
